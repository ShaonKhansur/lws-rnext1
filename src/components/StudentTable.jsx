...
export default function StudentTable() {
  ...
  const [classTwoData, setClassTwoData] = useState([]);
  useEffect(() => {
    setClassOneData(tableData.classOne);
    setClassTwoData(tableData.classTwo);
  }, []);
  return (
                  ...
                  <td className="p-5 text-sm md:text-xl">
                    <div className="flex space-x-3 items-center">
                      <img
                        ...
                        alt="John Smith"
                      />
                      <span className="whitespace-nowrap">J{data.name}</span>
                    </div>
                  </td>
